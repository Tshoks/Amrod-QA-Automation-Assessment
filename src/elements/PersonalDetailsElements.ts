export class PersonalDetailsElements {
  private readonly personalDetailsHeader: string = '//h6[normalize-space()="Personal Details"]';
  ...
  private readonly dateOfBirthInput: string = '//label[normalize-space()="Date of Birth"]/ancestor::div[contains(@class,"oxd-input-group")]//input';
  private readonly genderMaleRadio: string = '//label[normalize-space()="Male"]';
  private readonly genderFemaleRadio: string = '//label[normalize-space()="Female"]';
  private readonly addAttachmentButton: string = '//h6[normalize-space()="Attachments"]/ancestor::div[contains(@class,"orangehrm-card-container")]//button[normalize-space()="Add"]';
  private readonly browseInput: string = 'input[type="file"]';
  private readonly saveAttachmentButton: string = '//input[@type="file"]/ancestor::form//button[normalize-space()="Save"]';
  private readonly saveButton: string = '//label[normalize-space()="Nationality"]/ancestor::form//button[normalize-space()="Save"]';
